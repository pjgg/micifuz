...
public class SimpleTest {
    ...
    void should_healthCheck_up(Vertx vertx, VertxTestContext testContext) {
        ...
        client.request(HttpMethod.GET, servicePort, VETS_HOST, "/health").compose(req -> req.send()
    ...
    private static void ServiceStart(Vertx vertx, VertxTestContext testContext) throws IOException {
        Runner.start(vertx, new DeploymentOptions().setConfig(getDefaultAppConfig()), VetsMainVerticle.class.getName())
